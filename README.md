...
*   **5 Difficulty Levels & Progression Locks**:
    ...
    *   Earn up to **9 unique badges** based on your milestones (e.g. Boulder Badge for Simple, Cascade for Medium, Thunder for Hard, plus special achievements like solving a puzzle in under 3 minutes or finishing with 0 mistakes!).
